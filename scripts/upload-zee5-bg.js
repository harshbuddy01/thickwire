...
async function upload() {
  const body = fs.readFileSync('/Users/harshanand/.gemini/antigravity/brain/7be811f1-805f-4622-81fe-8ee3e80d051b/zee5_hero_bg_1777584704479.png');
  await client.send(new PutObjectCommand({
    Bucket: 'streamkart-assets',
    Key: 'slider/zee5-hero-bg.png',
    Body: body,
