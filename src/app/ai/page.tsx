...
export const metadata: Metadata = {
    title: 'Premium AI Subscriptions — StreamKart',
    description: 'Unlock official premium access to ChatGPT Plus, Gemini Advanced, Claude Pro, Perplexity Pro, Midjourney and more from StreamKart.',
};
