    ...
    if (isSuccess) {
        return (
            <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
                <div className="w-full max-w-md bg-[#111] border border-[#222] rounded-2xl p-8 shadow-2xl text-center">
        ...
        <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 py-12">
            <div className="w-full max-w-md bg-[#111] border border-[#222] rounded-2xl p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <p className="text-gray-400">Join ThickWire to manage all your purchases</p>
                </div>
                ...
                <form onSubmit={handleSignup} className="space-y-4 relative z-10">
                    ...
                    <div>
                        ...
                        <p className="mt-1.5 ml-1 text-xs text-gray-500">Must be at least 8 characters</p>
                    </div>
                ...
                <div className="mt-8 relative z-10 flex items-center gap-4">
                    ...
                    <span className="text-xs font-medium text-gray-500 uppercase tracking-widest">Or signup with</span>
                    <div className="h-px bg-[#333] flex-1"></div>
                </div>
                ...
                <p className="mt-8 text-center text-sm text-gray-400 relative z-10">
                    ...
                    <Link href={`/login?redirect=${encodeURIComponent(redirectUrl)}`} className="text-white font-medium hover:underline">
                        Sign in
                    </Link>
                </p>
            </div>
