...
export const metadata: Metadata = {
    title: 'Premium Streaming Subscriptions — StreamKart',
    description: 'Unlock official premium access to Netflix, Prime Video, ZEE5, Sony LIV, YouTube Premium, Disney+, Crunchyroll, Spotify, and more from StreamKart.',
};
