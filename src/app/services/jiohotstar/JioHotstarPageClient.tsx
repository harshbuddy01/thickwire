...
import { ChevronRight, Check, Lock, Mail, Play, Zap, Star, Monitor } from 'lucide-react';
        ...
        <div style={{ background: '#f8fafc', minHeight: '100vh', fontFamily: 'var(--font-poppins), sans-serif', paddingBottom: '80px' }}>
            <div className="container">
                <nav style={{ padding: '20px 0', fontSize: '13px', color: '#6b7280', display: 'flex', gap: '8px', alignItems: 'center' }}>
                    ...
                    <ChevronRight size={14} />
                    <span style={{ fontWeight: 700, color: '#111827' }}>JioHotstar</span>
                </nav>
            </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginBottom: '24px' }}>
                                                <div style={{ background: isSelected ? '#dbeafe' : '#f8fafc', color: isSelected ? '#0a3a82' : '#64748b', padding: '12px', borderRadius: '12px' }}>
                                                    <Play size={24} />
                                                </div>
                                                <div>
                            ...
                            {selectedPlan && (
                                <>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
                                        <div style={{ width: '48px', height: '48px', borderRadius: '12px', flexShrink: 0, background: 'linear-gradient(135deg, #092ca8 50%, #e4003b 50%)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <span style={{ color: '#fff', fontSize: '0.6rem', fontWeight: 900, textAlign: 'center', lineHeight: 1.1 }}>Jio<br/>Hotstar</span>
                                        </div>
                                        <div>
                                            <div style={{ fontSize: '0.95rem', fontWeight: 700, color: '#111827' }}>JioHotstar</div>
