        ...
        <div className="netflix-page-exact">
            ...
            <div className="container">
                <nav className="breadcrumb-nav">
                    ...
                    <ChevronRight size={14} />
                    <span className="current">Netflix</span>
                </nav>
            </div>
            ...
            <div className="container">
                ...
                <div className="plans-section">
                    ...
                    <div className="plans-grid">
                        {/* 3 Months Plan */}
                        <div className="plan-card card-red">
                            <div className="plan-badge badge-red">PREMIUM PLAN</div>
                            <div className="plan-content">
                                ...
                                <ul className="plan-features">
                                    <li><Check size={16} className="text-red" /> Full HD / 4K Ultra HD Quality</li>
                                    <li><Check size={16} className="text-red" /> Watch on 1 Device</li>
                                    <li><Check size={16} className="text-red" /> All Netflix Content Access</li>
                                    <li><Check size={16} className="text-red" /> Ad-free Experience</li>
                                    <li><Check size={16} className="text-red" /> Works on TV, Mobile, Laptop</li>
                                </ul>
                                <button className="plan-btn bg-red">
                        ...
                        {/* 6 Months Plan */}
                        <div className="plan-card card-purple">
                            <div className="plan-badge badge-purple">PREMIUM PLAN</div>
                            <div className="plan-content">
                                ...
                                <ul className="plan-features">
                                    <li><Check size={16} className="text-purple" /> Full HD / 4K Ultra HD Quality</li>
                                    <li><Check size={16} className="text-purple" /> Watch on 1 Device</li>
                                    <li><Check size={16} className="text-purple" /> All Netflix Content Access</li>
                                    <li><Check size={16} className="text-purple" /> Ad-free Experience</li>
                                    <li><Check size={16} className="text-purple" /> Works on TV, Mobile, Laptop</li>
                                </ul>
                                <button className="plan-btn bg-purple">
                                    <ShoppingCart size={18} /> Buy Now
                                </button>
                            </div>
                        </div>
                        ...
                        {/* 12 Months Plan */}
                        <div className="plan-card card-blue best-value">
                            <div className="best-value-ribbon">BEST VALUE</div>
                            <div className="plan-badge badge-blue">PREMIUM PLAN</div>
                            <div className="plan-content">
                                ...
                                <ul className="plan-features">
                                    <li><Check size={16} className="text-blue" /> Full HD / 4K Ultra HD Quality</li>
                                    <li><Check size={16} className="text-blue" /> Watch on 1 Device</li>
                                    <li><Check size={16} className="text-blue" /> All Netflix Content Access</li>
                                    <li><Check size={16} className="text-blue" /> Ad-free Experience</li>
                                    <li><Check size={16} className="text-blue" /> Works on TV, Mobile, Laptop</li>
                                </ul>
                                <button className="plan-btn bg-blue">
                                    <ShoppingCart size={18} /> Buy Now
                                </button>
                            </div>
                        </div>
                ...
                <div className="info-split">
                    <div className="why-section">
                        <h3 className="section-title">Why Choose Netflix?</h3>
