    ...
    return (
        <div className="container home-container" style={{ paddingBottom: '80px', paddingTop: '80px' }}>
            ...
            <div className="blocks-parent-grid category-blocks-grid">
                ...
                <Link href="/activation" style={{ display: 'block', borderRadius: '24px', overflow: 'hidden', aspectRatio: '3/2', textDecoration: 'none' }}>
                ...
                <Link href="/vpn" style={{ display: 'block', borderRadius: '24px', overflow: 'hidden', aspectRatio: '3/2', textDecoration: 'none' }}>
                    <ProgressiveImage src={`${MINIO_URL}/blocks/vpn.png`} alt="VPN Services" />
                </Link>
                <Link href="/education" style={{ display: 'block', borderRadius: '24px', overflow: 'hidden', aspectRatio: '3/2', textDecoration: 'none' }}>
                    <ProgressiveImage src={`${MINIO_URL}/blocks/ai.png`} alt="Education" />
                </Link>
            </div>
